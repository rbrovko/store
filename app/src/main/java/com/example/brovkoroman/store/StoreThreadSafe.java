...
public class StoreThreadSafe extends Store {
    ...
    @Override
    public void setBooleanArray(String pKey, boolean[] pBooleanArray) {
        synchronized (LOCK) {
            super.setBooleanArray(pKey, pBooleanArray);
        }
    }
    ...
    @Override
    public Color[] getColorArrya(String pKey) throws NotExistingKeyException, InvalidTypeException {
        synchronized (LOCK) {
            return super.getColorArrya(pKey);
        }
    }
